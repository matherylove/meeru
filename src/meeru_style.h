...
inline QString sheet()
{
    return QString::fromLatin1(
        ...
        "#serverTab:hover { color: #FFF7FC; }"
        "#serverTab:checked { color: #FFF7FC; font-weight: bold; border-bottom-color: #DFB2F4; }"
        "#memberName { color: #E4D6EA; font-size: 12px; background: transparent; }"
        "#memberStatus { color: #9d8ba5; font-size: 10px; background: transparent; }"
        ...
        "#railButton:hover { color: #FFF7FC; background: #2f2139; }"
        "#railButton:checked { color: #DFB2F4; font-weight: bold; background: #35264066; }"
        "#mediaStage { background: #160F1D; border-bottom: 1px solid #634A70; color: #9d8ba5;"
        "              font-size: 12px; }"
        "#dmHistory { background: #241B2E; border: 0; padding: 4px 10px; }"
        "#dmTyping { color: #ae9bb6; font-size: 10px; font-style: italic; background: #241B2E; }"
        "#dmComposeWrap { background: #1a1322; border-top: 1px solid #634A70; }"
        "#dmCompose { background: #19121f; border: 1px solid #634A70; border-radius: 6px;"
        "             color: #FFF7FC; font-size: 12px; padding: 0 8px; }"
        "#dmCompose:focus { border-color: #DFB2F4; }"
